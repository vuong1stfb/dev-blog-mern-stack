    ...
    if (value === "") {
      ...
      if (value === "Khác") {
            if(textInput === ""){
              ...
              await postAPI("report-user", {message: textInput, user_report: slug}, access_token).then(res => {
                handleOpen()
              }).catch(err => {
        ...
        const result = await checkTokenExp(auth.access_token, dispatch);
        const access_token = result ? result : auth.access_token;
        await postAPI("report-user", {message: value, user_report: slug}, access_token).then(res => {
          handleOpen()
        }).catch(err => {
          dispatch({ type: ALERT, payload: { errors: err.response.data.msg } });
        })
        ...
        <div className="header">
          ...
          <Content>
            <div className="body">
              <div className="header">
                <div className="reading-list">
                  <h1 style={{ fontWeight: "bold" }}>Báo cáo tài khoản</h1>
